...
func main() {
	...
	absPath, _ := filepath.Abs("../multithreading-golang/channels/data/")
	...
	for _, file := range files {
		...
		text := string(dat)
		textChannel <- text
		//metaReports := parseToArray(text)
		//windDirections := extractWindDirection(metaReports)
